...
// Настройки
const folder_main    = `gr-bnw_maria/`;
const file_html_list     = [
'index.html'
]

const root_path     = `L:/Dropbox/CPA/Server/healthy-step.server/landers/dating/s/`;
const folder_html   = ''
const folder_css    = ''
const folder_js     = ''
...
if ( fs.existsSync(root_path+folder_secure) ) {
        ...
        fs.mkdir(root_path+_secure, ()=>console.log('created "_secure"'))
